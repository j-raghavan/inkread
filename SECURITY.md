...
(Security → Advisories) so we can triage and fix before disclosure. This keeps the report
confidential and notifies the maintainers directly — please use it rather than any public channel.
