-- KOReader's bundled example plugin, shipped as a built-in so the Plugins menu has something to
-- run out of the box. If this works on-device, the KOReader common-core shim is live (RR14).
